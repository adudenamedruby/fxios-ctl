...
// fxios - CLI tool for firefox-ios development
//
// Commands validate they're run within a valid firefox-ios repo via RepoDetector,
// which looks for .fxios.yaml at the repository root.

import ArgumentParser
import Foundation

@main
struct Fxios: ParsableCommand {
    ...
    static func main() {
        ...
        do {
            ...
            if let fxios = command as? Fxios, fxios.debug {
                Logger.isDebugEnabled = true
            }
