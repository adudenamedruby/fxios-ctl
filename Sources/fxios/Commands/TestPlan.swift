...
enum TestError: Error, CustomStringConvertible {
    ...
    var description: String {
        ...
        case .testBundleNotFound(let path):
            return "Test bundle not found at \(path). Run 'fxios test --build-first' to build tests."
        case .xctestrunNotFound(let pattern):
            return "No xctestrun file found matching '\(pattern)'. Run 'fxios build --for-testing' first."
